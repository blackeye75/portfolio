...
const Marque = () => {
  return (
    <div className="w-full md:py-4 py-7 rounded-tl-3xl rounded-tr-3xl bg-black">
      <div className="text border-t-2 border-b-2 border-zinc-600 flex  text-black whitespace-nowrap overflow-hidden p-4 ">
        ...
        <motion.img
          ...
          alt=""
          className="w-[30vw] backdrop-blur-sm   h-[10vw] rounded-full px-9"
        />
        <motion.img
          initial={{ x: 0 }}
          animate={{ x: "-100%" }}
        ...
        <motion.img
          ...
          alt=""
          className="w-[30vw] backdrop-blur-sm   h-[10vw] rounded-full px-10"
        />
        <motion.img
          initial={{ x: 0 }}
          animate={{ x: "-100%" }}
        ...
        <motion.img
          ...
          src="https://images.unsplash.com/photo-1499914485622-a88fac536970?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt=""
          className="w-[30vw] backdrop-blur-sm   h-[10vw] rounded-full "
        />
        <motion.img
          initial={{ x: 0 }}
          animate={{ x: "-100%" }}
